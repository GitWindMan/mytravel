    ...
    <td height="30">
	  <table width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr>
		  ...
		  <span class="STYLE4" >优惠列表</span></td>
          ...
          <td bgcolor="e5f1d6">
			<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CECECE">
				<tr>
					...
					<th width="10%" height="26" background=" " class="STYLE1">
						<div align="center" class="STYLE2 STYLE1">商家</div></th>
						
					<th width="10%" height="26" background=" " class="STYLE1" colspan="3">
					...
					<tr>
						<td height="20" bgcolor="#FFFFFF">
							<div align="center" class="STYLE2 STYLE1">
								<a href="front!newsIntro.action?news.id=<s:property value="id"/>" target="_blank">
						...
						<%-- <td height="20" bgcolor="#FFFFFF"><div align="center">
							<span class="STYLE1"> [</span><a href="reply!list.action?newsid=<s:property value="id"/>">查看留言</a><span class="STYLE1">]</span></div></td> --%>
						<%-- <td height="20" bgcolor="#FFFFFF"><div align="center">
							<img src="images/037.gif" width="9" height="9" /><span class="STYLE1"> [</span><a href="news!updatePage.action?news.id=<s:property value="id"/>">修改</a><span class="STYLE1">]</span></div></td> --%>
						<td height="20" bgcolor="#FFFFFF"><div align="center">
							<img src="images/010.gif" width="9" height="9" /><span class="STYLE1">[</span><a href="news!delete.action?news.id=<s:property value="id"/>">删除</a><span class="STYLE1">]</span></div></td>
					</tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
		  <tr>
			...
			<div style="width: 140px;float: right;">
				<a href="news!list.action?page=${page==1 ? 1 : page-1}">上一页</a> [${page}/${pages}] 
				<a href="news!list.action?page=${page==pages ? pages : page+1}">下一页</a>
			</div></td>
