    ...
    <td height="30">
	  <table width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr>
		  ...
		  <span class="STYLE4" >游记列表</span></td>
        ...
        <tr>
          ...
          <td bgcolor="e5f1d6">
			<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CECECE">
				<tr>
					<th width="40%" height="26" background=" " class="STYLE1">
					...
					<tr>
						<td height="20" bgcolor="#FFFFFF">
							<div align="center" class="STYLE2 STYLE1">
								<a href="front!noteIntro.action?note.id=<s:property value="id"/>" target="_blank">
						...
						<td height="20" bgcolor="#FFFFFF"><div align="center">
							<img src="images/010.gif" width="9" height="9" /><span class="STYLE1">[</span><a href="note!delete.action?note.id=<s:property value="id"/>">删除</a><span class="STYLE1">]</span></div></td>
					</tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
		  <tr>
			...
			<div style="width: 140px;float: right;">
				<a href="note!list.action?page=${page==1 ? 1 : page-1}">上一页</a> [${page}/${pages}] 
				<a href="note!list.action?page=${page==pages ? pages : page+1}">下一页</a>
			</div></td>
