       ...
       <div class="boxes">
		<ul>
           	<li class="shadowStyle" style="width:700px;float:left;">
               	<h2>
               		<span style="float:left;margin: 0 0 20px 10px;">游记信息</span>
               		<s:if test="#session.type==1 && #session.user.status==0">
	               		<span style="float:right;margin: 0 20px;"><a href="pages/note-add.jsp">发布游记</a></span>
	               		<span style="float:right;margin: 0 20px;"><a href="front!noteSelf.action?userid=${user.id}">我的游记</a></span>
               		</s:if>
               	</h2> 
               	<br/>
               	<br/>
				...
				<div class="leftList" style="margin-left:20px;">
					...
					<div style="width: 200px;margin: 20px 0 0 260px;">
						<a href="front!noteList.action?page=${page==1 ? 1 : page-1}">上一页</a> [${page}/${pages}] <a href="front!noteList.action?page=${page==pages ? pages : page+1}">下一页</a>
					</div>
				</div>
               </li>
           </ul>
