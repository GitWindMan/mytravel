       ...
       <div class="boxes">
		<ul>
           	<li class="shadowStyle" style="width:700px;float:left;">
               	<h2>
               		<span style="float:left;margin: 0 0 20px 10px;">我的优惠</span>
				...
				<div class="leftList" style="margin-left:20px;">
					<ul>
						<s:iterator value="newses">
							<li style="width:600px;">
								...
								<span style="float:right;"><a href="front!newsDrop.action?news.id=<s:property value='id'/>&userid=${user.id}">[删除]</a></span>
								<span style="float:right;"><a href="front!newsEdit.action?news.id=<s:property value='id'/>">[修改]</a></span>
					...
					<div style="width: 200px;margin: 20px 0 0 260px;">
						<a href="front!newsSelf.action?userid=${user.id}&page=${page==1 ? 1 : page-1}">上一页</a> [${page}/${pages}] <a href="front!newsSelf.action?userid=${user.id}&page=${page==pages ? pages : page+1}">下一页</a>
					</div>
				</div>
               </li>
           </ul>
